...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXfixes_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("d091e8ba-531a-589c-9de9-94069b037ed8"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXfixes; unsupported platform $(triplet(platform_key_abi()))")
else
